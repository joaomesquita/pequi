...
<head>
    ...
    <title>Pequi Pousada Pantaneira</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img src="img/logo.svg" alt="" class="img-fluid" width="180">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav align-items-center ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="pousada.php">A Pousada</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item ms-2">
                        <a href="#" class="btn btn-outline-primary">Reservas <i class="bi bi-arrow-right color-primary"></i></a>
                    </li>
                </ul>
            </div>
        </div>
